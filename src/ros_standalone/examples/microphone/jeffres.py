...
# sample_rate, stereo_data = wav.read(f"white_noise/white_noise_front_20db.wav")
# sound_left = TimedArray(stereo_data[:, 0].astype(float32), dt=defaultclock.dt)
# sound_right = TimedArray(stereo_data[:, 1].astype(float32), dt=defaultclock.dt)
